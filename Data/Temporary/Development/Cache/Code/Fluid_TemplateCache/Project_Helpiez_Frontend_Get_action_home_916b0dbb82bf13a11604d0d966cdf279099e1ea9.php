<?php class FluidCache_Project_Helpiez_Frontend_Get_action_home_916b0dbb82bf13a11604d0d966cdf279099e1ea9 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '" class="ls-bg" alt="Slide background">
    ...
    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 search-dialog form" style="z-index:100001">
            ...
            <form action="search.php" method="post">
                <ul style="display:inline-block">
                    ...
                    <li class="search-list">
                        ...
                        <li class="search-suggest-list"><a href="#">Education</a></li>
                        <li class="search-suggest-list"><a href="#">Women</a></li>
                        <li class="search-suggest-list"><a href="#">Community</a></li>
                        <li class="search-suggest-list"><a href="#">Animals</a></li>
                        <li class="search-suggest-list"><a href="#">Art & Culture</a></li>
                        <li class="search-suggest-list"><a href="#">Environment</a></li>
                        <li class="search-suggest-list"><a href="#">Health & Medicine</a></li>
                        <li class="search-suggest-list"><a href="#">Violence & Injustice</a></li>
