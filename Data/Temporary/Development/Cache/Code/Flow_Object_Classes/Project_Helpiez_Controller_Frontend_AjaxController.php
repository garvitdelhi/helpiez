 ...
 */
class AjaxController_Original extends ActionController {
	...
	public function filterSearchAction($key = "", $ngoCause = "", $ngoLocation = "", $opportunityLocation = "") {
		...
		$this->filterSearch->setNgoLocation($ngoLocation);
 ...
 * Class AjaxController
 */
class AjaxController extends AjaxController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('Project\Helpiez\Controller\Frontend\AjaxController' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('Project\Helpiez\Controller\Frontend\AjaxController');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionService->isPropertyAnnotatedWith('Project\Helpiez\Controller\Frontend\AjaxController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('Project\Helpiez\Controller\Frontend\AjaxController', $propertyName, 'var');
