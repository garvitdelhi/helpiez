...
class MediaTypeConverter extends MediaTypeConverter_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Property\TypeConverter\MediaTypeConverter', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
