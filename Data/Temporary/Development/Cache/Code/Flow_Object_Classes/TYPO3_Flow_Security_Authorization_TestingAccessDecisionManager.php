...
class TestingAccessDecisionManager extends TestingAccessDecisionManager_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyAnnotatedWith('TYPO3\Flow\Security\Authorization\TestingAccessDecisionManager', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
